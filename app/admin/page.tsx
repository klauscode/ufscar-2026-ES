    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        ...
        <form action="/api/admin/logout" method="POST">
          <button type="submit" className="text-sm px-3 py-1.5 rounded-lg transition-all font-medium" style={{ color: 'var(--text-2)', background: 'var(--surface-2)', border: '1px solid var(--border)' }}>
            Sair
          </button>
        </form>
      </div>
